...
border: solid #DDDDDD;border-width: 0px thin 0px ">
        ...
        <table class="table table-striped" style="border:1px solid  #DDDDDD">
            ...
            <c:forEach items="${rankHot}" var="rankhot" varStatus="status">
                <tr >
                    ...
                    <td>${rankhot.song_name}</td>
                    <td><a style="text-decoration: none;color: #000000;" href="singer?singer_name=${rankhot.singer_name}">${rankhot.singer_name}</a></td>
