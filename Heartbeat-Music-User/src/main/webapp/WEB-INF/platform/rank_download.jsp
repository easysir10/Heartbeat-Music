...
border: solid #DDDDDD;border-width: 0px thin 0px ">
        ...
        <div>
            <div style="float: left;width: 160px;height: 40px"><a href="rank" class="list-group-item">最新歌曲</a></div>
            <div style="float: left;width: 160px;height: 40px"><a href="rank_hot" class="list-group-item">最热歌曲</a></div>
            <div style="float: left;width: 160px;height: 40px"><a href="rank_download" class="list-group-item">下载最多</a></div>
            <div style="float: left;width: 160px;height: 40px"><a href="rank_sort" class="list-group-item">按类别显示</a></div>
        </div>
        ...
        <table class="table table-striped" style="border:1px solid  #DDDDDD">
            ...
            <c:forEach items="${rankDownload}" var="rankdownload" varStatus="status">
                <tr >
                    ...
                    <td>${rankdownload.song_name}</td>
                    <td><a style="text-decoration: none;color: #000000;" href="singer?singer_name=${rankdownload.singer_name}">${rankdownload.singer_name}</a></td>
