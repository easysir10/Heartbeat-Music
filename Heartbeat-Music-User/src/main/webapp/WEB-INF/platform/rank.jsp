...
border: solid #DDDDDD;border-width: 0px thin 0px ">
        ...
        <table class="table table-striped" style="border:1px solid  #DDDDDD">
            ...
            <c:forEach items="${rankNew}" var="ranknew" varStatus="status">
                <tr >
                    ...
                    <td>${ranknew.song_name}</td>
                    <td><a style="text-decoration: none;color: #000000;" href="singer?singer_name=${ranknew.singer_name}">${ranknew.singer_name}</a></td>
